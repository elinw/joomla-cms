...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_tags&task=j.saveorderajax.tags&tmpl=component';
...
<?php endif;?>
		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				...
				<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('JSEARCH_FILTER'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" class="hasTooltip" title="<?php echo JHtml::tooltipText('COM_TAGS_SEARCH_IN_TITLE'); ?>" />
			</div>
		...
		<table class="table table-striped" id="articleList">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->parent?>">
					...
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->published, $i, 'j.updatestatelist.', $canChange); ?>
					</td>
					<td>
						...
						<?php endif; ?>
						<?php if ($canEdit) : ?>
							<a href="<?php echo JRoute::_('index.php?option=com_tags&view=tag&controller=j.displayform.tag.edit&id='.(int) $item->id); ?>">
