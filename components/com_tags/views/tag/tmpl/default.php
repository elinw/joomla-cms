...
<?php  if (count($this->item) == 1 && ($this->params->get('show_description', 1) || $this->params->get('show_description_image', 1))) : ?>
	<div class="category-desc"><?php $this->params->get('show_description_image', 1); ?>
	<?php  if ($this->params->get('show_description_image', 1)== 1 && $this->item[0]->images) :?>
...
<?php elseif ($this->state->params->get('show_description', 1) || $this->state->params->get('show_description_image', 1)): ?>
		<?php  if ($this->state->params->get('show_description_image', 1)== 1 && $this->state->params->get('tag_list_image')) :?>
			<img src="<?php echo $this->item[0]->get('images');?>">
		<?php endif; ?>
